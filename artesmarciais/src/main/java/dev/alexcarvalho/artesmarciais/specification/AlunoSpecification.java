package dev.alexcarvalho.artesmarciais.specification;
...
public class AlunoSpecification {
    ...
    //Aqui montei uma cláusula WHERE de um select
    ...
    //Copiei o metodo de cima, mas a idéia é que se ele não passou a informação retorna nulo.
